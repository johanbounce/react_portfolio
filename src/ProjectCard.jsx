  ...
  return (
        <div class="ui card" style={{borderRadius: "roundest", border: "solid 5px white", marginBottom: 20}}>
          ...
          <div style={{backgroundColor: "black"}} class="content">
            ...
            <div style={{marginBottom: 5, wordWrap: "break-word"}} class="extra content"><a class="project web"className={styles.linkcard} href={project.web} target="_blank" >{project.web}</a></div>
